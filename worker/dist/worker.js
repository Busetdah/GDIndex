...
(function () {
  ...
  async function onGet(request) {
    ...
    if (path.startsWith('/~_~_gdindex/resources/')) {
      ...
      const r = await fetch(`https://raw.githubusercontent.com/Busetdah/GDIndex/master/web/dist/${remain}`);
